...
app = FastAPI(title="AS AI PA", version=__version__, lifespan=_lifespan)
...
async def start_telegram_onboarding(body: TelegramOnboardingStart):
    bot_name = (body.bot_name or "AS AI PA").strip() or "AS AI PA"
...
def start_server(
    ...
    # Railway public deployment - temporarily disable auth gate
