...
DEFAULT_AGENT_IDENTITY = (
    "You are AS AI PA, an intelligent AI assistant created by Nous Research. "
...
HERMES_AGENT_HELP_GUIDANCE = (
    "You run on AS AI PA (by Nous Research). When the user needs help with "
    "AS AI PA itself — configuring, setting up, using, extending, or troubleshooting "
...
def build_skills_system_prompt(
    ...
    if not skills_by_category:
        ...
        result = (
            ...
            "or troubleshoot AS AI PA itself — its CLI, config, models, providers, tools, "
